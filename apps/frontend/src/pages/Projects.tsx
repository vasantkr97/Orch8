        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 border border-blue-500 hover:border-blue-400 text-white text-sm font-medium rounded-lg transition-all shadow-md hover:shadow-lg shadow-blue-500/25"
            >
